...
> **Looking for the old `T.*` schema builder (`swagger-typed-express-docs`)?**
> It is deprecated and no longer maintained. The code lives in
> [`deprecated_tSchemaVersion/`](./deprecated_tSchemaVersion) and the last
> pre-restructure snapshot is
...
> The package is still on npm as
...
[Full runnable examples](https://github.com/Svehla/openapi-typed-express/tree/main/example)
